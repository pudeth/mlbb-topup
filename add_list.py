...
# Add to interface
if 'Task<string> GetTransactionListAsync' not in text:
    text = text.replace('Task<string> CloseTransactionAsync(string tranId);',
                        'Task<string> CloseTransactionAsync(string tranId);\n        Task<string> GetTransactionListAsync(string fromDate = "", string toDate = "", string fromAmount = "", string toAmount = "", string status = "", string page = "1", string pagination = "40");')
...
if 'GetTransactionListAsync(string fromDate' not in text:
    text = text.rstrip()
...
if 'GetTransactionList' not in ctrl_text:
